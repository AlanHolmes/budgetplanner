<form action="{{ $formAction }}" method="POST">
            ...
            <div class="form-group row mb-0">
              ...
              <div class="col col-sm-6">
                <div class="btn-group" data-toggle="buttons">
                  <label class="btn btn-light {{ old('frequency', ($budget->frequency ?? 'monthly')) == 'monthly' ? 'active' : '' }}">
  ...
  <div class="container">
    <div class="form-group text-right">
      <button class="btn btn-primary">{{ $buttonText or 'Save' }}</button>
    </div>
  </div>
